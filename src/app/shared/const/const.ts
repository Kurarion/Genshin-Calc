...
export class Const {
  ...
  static readonly ELEMENT_MOON_RUPTURE = 'MOON_RUPTURE';
  ...
  static readonly SHIELD_BG_GRADIENT = ['radial-gradient(145deg, ', ' 60%,  rgba(0,0,0,0.3) 65%)'];

  static readonly QUALITY_ORANGE_BG =
    'linear-gradient(145deg, rgba(149,106,67,1) 12%, rgba(222,147,81,1) 86%)';
  static readonly QUALITY_ORANGE_SP_BG =
    'linear-gradient(145deg, rgba(172,80,84,1) 12%, rgba(219,76,86,1) 86%)';
  static readonly QUALITY_PURPLE_BG =
    'linear-gradient(145deg, rgba(101,96,140,1) 12%, rgba(151,118,197,1) 86%)';
  static readonly QUALITY_TEMP_BG =
    'linear-gradient(145deg, rgba(74,74,74,1) 12%, rgba(130,130,130,1) 86%)';
  ...
  static readonly WEAPON_TYPE_LIST: WeaponType[] = [
  ...
  //*********************************
  //変数
  static readonly PROP_VAR_CHARA_1 = 'VAR_CHARA_1';
  static readonly PROP_VAR_CHARA_2 = 'VAR_CHARA_2';
  static readonly PROP_VAR_CHARA_3 = 'VAR_CHARA_3';
  static readonly PROP_VAR_CHARA_4 = 'VAR_CHARA_4';
  static readonly PROP_VAR_CHARA_5 = 'VAR_CHARA_5';
  static readonly PROP_VAR_CHARA_6 = 'VAR_CHARA_6';
  static readonly PROP_VAR_CHARA_7 = 'VAR_CHARA_7';
  static readonly PROP_VAR_CHARA_8 = 'VAR_CHARA_8';
  static readonly PROP_VAR_SET_1 = 'VAR_SET_1';
  static readonly PROP_VAR_SET_2 = 'VAR_SET_2';
  static readonly PROP_VAR_WEAPON_1 = 'VAR_WEAPON_1';
  static readonly PROP_VAR_WEAPON_2 = 'VAR_WEAPON_2';
  ...
  //生命力ベース(スペシャル)
  static readonly PROP_HP_BASE_EXTRA = 'HP_BASE_EXTRA';
  //攻撃力ベース(スペシャル)
  static readonly PROP_ATTACK_BASE_EXTRA = 'ATTACK_BASE_EXTRA';
  //防御力ベース(スペシャル)
  static readonly PROP_DEFENSE_BASE_EXTRA = 'DEFENSE_BASE_EXTRA';
  //元素爆発エネルギー
  ...
  //元素(増幅）（月結晶）ダメージ倍率乗算値
  static readonly PROP_DMG_RATE_MULTI_MOON_HYDROCRYSTALLIZE = 'DMG_RATE_MULTI_MOON_HYDROCRYSTALLIZE';
  //元素(増幅）（月開花）ダメージ倍率乗算値
  static readonly PROP_DMG_RATE_MULTI_MOON_RUPTURE = 'DMG_RATE_MULTI_MOON_RUPTURE';

  //元素(増幅）（月開花）基礎区乗算値
  static readonly PROP_DMG_BASICS_MULTI_MOON_RUPTURE = 'DMG_BASICS_MULTI_MOON_RUPTURE';
  ...
  //元素(増幅）（月開花）会心率アップ値
  static readonly PROP_DMG_CRIT_RATE_UP_ELEMENT_MOON_RUPTURE =
    'DMG_CRIT_RATE_UP_ELEMENT_MOON_RUPTURE';
  //元素(増幅）（月）会心率アップ値
  static readonly PROP_DMG_CRIT_RATE_UP_ELEMENT_MOON =
    'DMG_CRIT_RATE_UP_ELEMENT_MOON';
  ...
  //元素(増幅）（月開花）会心ダメージアップ値
  static readonly PROP_DMG_CRIT_DMG_UP_ELEMENT_MOON_RUPTURE =
    'DMG_CRIT_DMG_UP_ELEMENT_MOON_RUPTURE';
  //元素(増幅）（月）会心ダメージアップ値
  static readonly PROP_DMG_CRIT_DMG_UP_ELEMENT_MOON =
    'DMG_CRIT_DMG_UP_ELEMENT_MOON';

  //元素(増幅）（全）
  static readonly PROP_DMG_ELEMENT_UP = 'DMG_ELEMENT_UP';
  //元素(増幅）（月）
  static readonly PROP_DMG_ELEMENT_MOON_ALL_UP = 'DMG_ELEMENT_MOON_ALL_UP';
  //元素(増幅）（蒸発）
  ...
  //元素(増幅）（月結晶）
  static readonly PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_UP = 'DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_UP';
  //元素(増幅）（超電導）
  static readonly PROP_DMG_ELEMENT_SUPERCONDUCT_UP = 'DMG_ELEMENT_SUPERCONDUCT_UP';
  //元素(増幅）（拡散アップ値）
  static readonly PROP_DMG_ELEMENT_SWIRL_VAL_UP = 'DMG_ELEMENT_SWIRL_VAL_UP';
  //元素(増幅）（拡散）
  ...
  //元素(増幅）（月開花）
  static readonly PROP_DMG_ELEMENT_MOON_RUPTURE_UP = 'DMG_ELEMENT_MOON_RUPTURE_UP';
  // //元素(増幅）（開花）（倍率）
  ...
  //元素(増幅）（月開花）（グレードアップ）
  static readonly PROP_DMG_ELEMENT_MOON_RUPTURE_EXTRA_VAL_UP =
    'DMG_ELEMENT_MOON_RUPTURE_EXTRA_VAL_UP';
  //元素(増幅）（月感電）（グレードアップ）
  static readonly PROP_DMG_ELEMENT_MOON_ELECTROCHARGED_EXTRA_VAL_UP =
    'DMG_ELEMENT_MOON_ELECTROCHARGED_EXTRA_VAL_UP';
  //元素(増幅）（月結晶）（グレードアップ）
  static readonly PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_EXTRA_VAL_UP =
    'DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_EXTRA_VAL_UP';
  //元素(増幅）（開花）（グレードアップ）
  static readonly PROP_DMG_ELEMENT_RUPTURE_EXTRA_VAL_UP = 'DMG_ELEMENT_RUPTURE_EXTRA_VAL_UP';
  //元素(増幅）（列開花）（グレードアップ）
  static readonly PROP_DMG_ELEMENT_BURGEON_EXTRA_VAL_UP = 'DMG_ELEMENT_BURGEON_EXTRA_VAL_UP';
  //元素(増幅）（超開花）（グレードアップ）
  static readonly PROP_DMG_ELEMENT_HYPERBLOOM_EXTRA_VAL_UP = 'DMG_ELEMENT_HYPERBLOOM_EXTRA_VAL_UP';

  //元素(増幅）（月感電）（プロモーション）
  static readonly PROP_DMG_ELEMENT_MOON_ELECTROCHARGED_PROMOTION =
    'DMG_ELEMENT_MOON_ELECTROCHARGED_PROMOTION';
  //元素(増幅）（月開花）（プロモーション）
  static readonly PROP_DMG_ELEMENT_MOON_RUPTURE_PROMOTION = 'DMG_ELEMENT_MOON_RUPTURE_PROMOTION';
  //元素(増幅）（月結晶）（プロモーション）
  static readonly PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_PROMOTION =
    'DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_PROMOTION';
  //元素(増幅）（月）（プロモーション）
  static readonly PROP_DMG_ELEMENT_MOON_PROMOTION =
    'DMG_ELEMENT_MOON_PROMOTION';
  ...
  //敵防御マイナス(元素爆発）
  static readonly PROP_DMG_ENEMY_DEFENSE_DOWN_ELEMENTAL_BURST =
    'DMG_ENEMY_DEFENSE_DOWN_ELEMENTAL_BURST';
  //敵防御無視
  ...
  //敵防御無視(元素爆発）
  static readonly PROP_DMG_ENEMY_DEFENSE_IGNORE_ELEMENTAL_BURST =
    'DMG_ENEMY_DEFENSE_IGNORE_ELEMENTAL_BURST';
  ...
  static readonly PROP_TAG_RAIDEN_ISSHIN = 'RAIDEN_ISSHIN';
  static readonly PROP_TAG_EULA_KOUKEN = 'EULA_KOUKEN';
  static readonly PROP_TAG_CYNO_BOLT = 'CYNO_BOLT';
  static readonly PROP_TAG_CYNO_Q = 'CYNO_Q';
  static readonly PROP_TAG_NILOU_MOON = 'NILOU_MOON';
  static readonly PROP_TAG_NAHIDA_TRI_KARMA = 'NAHIDA_TRI_KARMA';
  static readonly PROP_TAG_LAYLA_SHOOTING_STAR = 'LAYLA_SHOOTING_STAR';
  static readonly PROP_TAG_FISCHL_OZ = 'FISCHL_OZ';
  static readonly PROP_TAG_ALHAITHAM_MIRROR = 'ALHAITHAM_MIRROR';
  static readonly PROP_TAG_DEHYA_FIELD = 'DEHYA_FIELD';
  static readonly PROP_TAG_LYNEY_GRIN_MALKIN = 'LYNEY_GRIN_MALKIN';
  static readonly PROP_TAG_FREMINET_FROST = 'FREMINET_FROST';
  static readonly PROP_TAG_FREMINET_SHATTERING_PRESSURE = 'FREMINET_SHATTERING_PRESSURE';
  static readonly PROP_TAG_TRAVELER_TORRENT_SURGE = 'TRAVELER_TORRENT_SURGE';
  static readonly PROP_TAG_TRAVELER_DEWDROP = 'TRAVELER_DEWDROP';
  static readonly PROP_TAG_WRIOTHESLEY_REBUKE = 'WRIOTHESLEY_REBUKE';
  static readonly PROP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT = 'NEUVILLETTE_EQUITABLE_JUDGMENT';
  static readonly PROP_TAG_FURINA_SALON_SOLITAIRE = 'FURINA_SALON_SOLITAIRE';
  static readonly PROP_TAG_FURINA_NORMAL_C6 = 'FURINA_NORMAL_C6';
  static readonly PROP_TAG_NAVIA_SHARDSHOT = 'NAVIA_SHARDSHOT';
  static readonly PROP_TAG_GAMING_BESTIAL_ASCENT = 'GAMING_BESTIAL_ASCENT';
  static readonly PROP_TAG_SETHOS_DUSK_BOLTS = 'SETHOS_DUSK_BOLTS';
  static readonly PROP_TAG_SETHOS_SHADOWPIERCING_SHOTS = 'SETHOS_SHADOWPIERCING_SHOTS';
  static readonly PROP_TAG_EMILIE_CLEARDEW_COLOGNE = 'EMILIE_CLEARDEW_COLOGNE';
  static readonly PROP_TAG_KINICH_SCALESPIKER_CANNON = 'KINICH_SCALESPIKER_CANNON';
  static readonly PROP_TAG_MUALANI_SHARKY_BITE = 'MUALANI_SHARKY_BITE';
  static readonly PROP_TAG_CHASCA_SHADOWHUNT_SHELL = 'CHASCA_SHADOWHUNT_SHELL';
  static readonly PROP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL = 'CHASCA_SHINING_SHADOWHUNT_SHELL';
  static readonly PROP_TAG_ORORON_HYPERSENSE = 'ORORON_HYPERSENSE';
  static readonly PROP_TAG_MAVUIKA_FLAMESTRIDER = 'MAVUIKA_FLAMESTRIDER';
  static readonly PROP_TAG_CITLALI_FROSTFALL_STORM = 'CITLALI_FROSTFALL_STORM';
  static readonly PROP_TAG_CITLALI_ICE_STORM = 'CITLALI_ICE_STORM';
  static readonly PROP_TAG_VARESA_PLUNGE = 'VARESA_PLUNGE';
  static readonly PROP_TAG_VARESA_FIERY_PASSION_PLUNGE = 'VARESA_FIERY_PASSION_PLUNGE';
  static readonly PROP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST =
    'VARESA_FIERY_PASSION_ELEMENTAL_BURST';
  static readonly PROP_TAG_VARESA_VOLCANO_KABLAM = 'VARESA_VOLCANO_KABLAM';
  static readonly PROP_TAG_SKIRK_SERPENT_SUBTLETY = 'SKIRK_SERPENT_SUBTLETY';
  static readonly PROP_TAG_SKIRK_SEVEN_PHASE_FLASH = 'SKIRK_SEVEN_PHASE_FLASH';
  static readonly PROP_TAG_NEFER_PHANTASM_PERFORMANCE = 'NEFER_PHANTASM_PERFORMANCE';
  static readonly PROP_TAG_DURIN_PRINCIPLE_OF_DARKNESS = 'DURIN_PRINCIPLE_OF_DARKNESS';
  static readonly PROP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT =
    'JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT';
  ...
  static readonly PROP_TAG_ALBEDO_TRANSIENT_BLOSSOM = 'ALBEDO_TRANSIENT_BLOSSOM';
  static readonly PROP_TAG_ALBEDO_FATAL_BLOSSOM = 'ALBEDO_FATAL_BLOSSOM';
  ...
  static readonly PROPS_TAG_LIST = [
    Const.PROP_TAG_RAIDEN_ITTOU,
    Const.PROP_TAG_RAIDEN_ISSHIN,
    Const.PROP_TAG_EULA_KOUKEN,
    Const.PROP_TAG_CYNO_BOLT,
    Const.PROP_TAG_CYNO_Q,
    Const.PROP_TAG_NILOU_MOON,
    Const.PROP_TAG_NAHIDA_TRI_KARMA,
    Const.PROP_TAG_LAYLA_SHOOTING_STAR,
    Const.PROP_TAG_FISCHL_OZ,
    Const.PROP_TAG_ALHAITHAM_MIRROR,
    Const.PROP_TAG_DEHYA_FIELD,
    Const.PROP_TAG_LYNEY_GRIN_MALKIN,
    Const.PROP_TAG_FREMINET_FROST,
    Const.PROP_TAG_FREMINET_SHATTERING_PRESSURE,
    Const.PROP_TAG_TRAVELER_TORRENT_SURGE,
    Const.PROP_TAG_TRAVELER_DEWDROP,
    Const.PROP_TAG_WRIOTHESLEY_REBUKE,
    Const.PROP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT,
    Const.PROP_TAG_FURINA_SALON_SOLITAIRE,
    Const.PROP_TAG_FURINA_NORMAL_C6,
    Const.PROP_TAG_NAVIA_SHARDSHOT,
    Const.PROP_TAG_GAMING_BESTIAL_ASCENT,
    Const.PROP_TAG_SETHOS_DUSK_BOLTS,
    Const.PROP_TAG_SETHOS_SHADOWPIERCING_SHOTS,
    Const.PROP_TAG_EMILIE_CLEARDEW_COLOGNE,
    Const.PROP_TAG_KINICH_SCALESPIKER_CANNON,
    Const.PROP_TAG_MUALANI_SHARKY_BITE,
    Const.PROP_TAG_CHASCA_SHADOWHUNT_SHELL,
    Const.PROP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL,
    Const.PROP_TAG_ORORON_HYPERSENSE,
    Const.PROP_TAG_MAVUIKA_FLAMESTRIDER,
    Const.PROP_TAG_CITLALI_FROSTFALL_STORM,
    Const.PROP_TAG_CITLALI_ICE_STORM,
    Const.PROP_TAG_VARESA_PLUNGE,
    Const.PROP_TAG_VARESA_FIERY_PASSION_PLUNGE,
    Const.PROP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST,
    Const.PROP_TAG_VARESA_VOLCANO_KABLAM,
    Const.PROP_TAG_SKIRK_SERPENT_SUBTLETY,
    Const.PROP_TAG_SKIRK_SEVEN_PHASE_FLASH,
    Const.PROP_TAG_NEFER_PHANTASM_PERFORMANCE,
    Const.PROP_TAG_DURIN_PRINCIPLE_OF_DARKNESS,
    Const.PROP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT,
    Const.PROP_TAG_RAZOR_SOUL_COMPANION,
    Const.PROP_TAG_VENTI_SKILL_PRESS,
    Const.PROP_TAG_ALBEDO_TRANSIENT_BLOSSOM,
    Const.PROP_TAG_ALBEDO_FATAL_BLOSSOM,
  ...
  static readonly PROPS_TAG_MAP: Map<string, string[]> = new Map([
    ['10000020', [Const.PROP_TAG_RAZOR_SOUL_COMPANION]],
    ['10000022', [Const.PROP_TAG_VENTI_SKILL_PRESS]],
    ['10000038', [Const.PROP_TAG_ALBEDO_TRANSIENT_BLOSSOM]],
    ['10000038', [Const.PROP_TAG_ALBEDO_FATAL_BLOSSOM]],
    ['10000052', [Const.PROP_TAG_RAIDEN_ITTOU, Const.PROP_TAG_RAIDEN_ISSHIN]],
    ['10000051', [Const.PROP_TAG_EULA_KOUKEN]],
    ['10000070', [Const.PROP_TAG_NILOU_MOON]],
    ['10000071', [Const.PROP_TAG_CYNO_BOLT, Const.PROP_TAG_CYNO_Q]],
    ['10000073', [Const.PROP_TAG_NAHIDA_TRI_KARMA]],
    ['10000074', [Const.PROP_TAG_LAYLA_SHOOTING_STAR]],
    ['10000031', [Const.PROP_TAG_FISCHL_OZ]],
    ['10000078', [Const.PROP_TAG_ALHAITHAM_MIRROR]],
    ['10000079', [Const.PROP_TAG_DEHYA_FIELD]],
    ['10000084', [Const.PROP_TAG_LYNEY_GRIN_MALKIN]],
    ['10000085', [Const.PROP_TAG_FREMINET_FROST, Const.PROP_TAG_FREMINET_SHATTERING_PRESSURE]],
    ['10000086', [Const.PROP_TAG_WRIOTHESLEY_REBUKE]],
    ['10000087', [Const.PROP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT]],
    ['10000089', [Const.PROP_TAG_FURINA_SALON_SOLITAIRE, Const.PROP_TAG_FURINA_NORMAL_C6]],
    ['10000091', [Const.PROP_TAG_NAVIA_SHARDSHOT]],
    ['10000092', [Const.PROP_TAG_GAMING_BESTIAL_ASCENT]],
    ['10000097', [Const.PROP_TAG_SETHOS_DUSK_BOLTS, Const.PROP_TAG_SETHOS_SHADOWPIERCING_SHOTS]],
    ['10000099', [Const.PROP_TAG_EMILIE_CLEARDEW_COLOGNE]],
    ['10000101', [Const.PROP_TAG_KINICH_SCALESPIKER_CANNON]],
    ['10000102', [Const.PROP_TAG_MUALANI_SHARKY_BITE]],
    ['10000104', [Const.PROP_TAG_CHASCA_SHADOWHUNT_SHELL]],
    ['10000104', [Const.PROP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL]],
    ['10000105', [Const.PROP_TAG_ORORON_HYPERSENSE]],
    ['10000106', [Const.PROP_TAG_MAVUIKA_FLAMESTRIDER]],
    ['10000107', [Const.PROP_TAG_CITLALI_FROSTFALL_STORM]],
    ['10000107', [Const.PROP_TAG_CITLALI_ICE_STORM]],
    ['10000111', [Const.PROP_TAG_VARESA_PLUNGE]],
    ['10000111', [Const.PROP_TAG_VARESA_FIERY_PASSION_PLUNGE]],
    ['10000111', [Const.PROP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST]],
    ['10000111', [Const.PROP_TAG_VARESA_VOLCANO_KABLAM]],
    ['10000114', [Const.PROP_TAG_SKIRK_SERPENT_SUBTLETY]],
    ['10000114', [Const.PROP_TAG_SKIRK_SEVEN_PHASE_FLASH]],
    ['10000122', [Const.PROP_TAG_NEFER_PHANTASM_PERFORMANCE]],
    ['10000123', [Const.PROP_TAG_DURIN_PRINCIPLE_OF_DARKNESS]],
    ['10000124', [Const.PROP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT]],
    ['10000005503', [Const.PROP_TAG_TRAVELER_TORRENT_SURGE, Const.PROP_TAG_TRAVELER_DEWDROP]],
    ['10000007703', [Const.PROP_TAG_FREMINET_FROST, Const.PROP_TAG_FREMINET_SHATTERING_PRESSURE]],
  ...
  static readonly PROPS_ALL_BASE_SPACIAL = [
    [Const.PROP_DMG_VAL_UP_NORMAL, Const.PROP_TAG_CYNO_Q],
    [Const.PROP_DMG_VAL_UP_NORMAL, Const.PROP_TAG_FURINA_NORMAL_C6],
    [Const.PROP_DMG_VAL_UP_CHARGED, Const.PROP_TAG_FURINA_NORMAL_C6],
    [Const.PROP_DMG_VAL_UP_CHARGED, Const.PROP_TAG_SETHOS_DUSK_BOLTS],
    [Const.PROP_DMG_VAL_UP_CHARGED, Const.PROP_TAG_SETHOS_SHADOWPIERCING_SHOTS],
    [Const.PROP_DMG_VAL_UP_PLUNGING, Const.PROP_TAG_FURINA_NORMAL_C6],
    [Const.PROP_DMG_VAL_UP_PLUNGING, Const.PROP_TAG_VARESA_PLUNGE],
    [Const.PROP_DMG_VAL_UP_SKILL, Const.PROP_TAG_TRAVELER_TORRENT_SURGE],
    [Const.PROP_DMG_VAL_UP_SKILL, Const.PROP_TAG_TRAVELER_DEWDROP],
    [Const.PROP_DMG_VAL_UP_SKILL, Const.PROP_TAG_CYNO_BOLT],
    [Const.PROP_DMG_VAL_UP_SKILL, Const.PROP_TAG_LAYLA_SHOOTING_STAR],
    [Const.PROP_DMG_VAL_UP_SKILL, Const.PROP_TAG_CITLALI_FROSTFALL_STORM],
    [Const.PROP_DMG_VAL_UP_ELEMENTAL_BURST, Const.PROP_TAG_CITLALI_ICE_STORM],
    [Const.PROP_DMG_VAL_UP_ELEMENTAL_BURST, Const.PROP_TAG_ALBEDO_FATAL_BLOSSOM],
    [Const.PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_EXTRA_VAL_UP, Const.PROP_TAG_ZIBAI_SPIRIT_STEED_SECOND_HIT],
  ];

  static readonly PROPS_ALL_BASE_SPACIAL_PERCENT = [
    [Const.PROP_DMG_BONUS_NORMAL, Const.PROP_TAG_SKIRK_SEVEN_PHASE_FLASH],
    [Const.PROP_DMG_BONUS_CHARGED, Const.PROP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_FREMINET_SHATTERING_PRESSURE],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_NILOU_MOON],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_NAHIDA_TRI_KARMA],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_LAYLA_SHOOTING_STAR],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_ALHAITHAM_MIRROR],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_DEHYA_FIELD],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_FURINA_SALON_SOLITAIRE],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_NAVIA_SHARDSHOT],
    [Const.PROP_DMG_BONUS_SKILL, Const.PROP_TAG_KINICH_SCALESPIKER_CANNON],
    [Const.PROP_DMG_BONUS_OTHER, Const.PROP_TAG_EMILIE_CLEARDEW_COLOGNE],
    [Const.PROP_DMG_BONUS_OTHER, Const.PROP_TAG_ORORON_HYPERSENSE],
    [Const.PROP_DMG_BONUS_ELEMENTAL_BURST, Const.PROP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST],
    [Const.PROP_DMG_BONUS_PLUNGING, Const.PROP_TAG_VARESA_VOLCANO_KABLAM],
    [Const.PROP_DMG_RATE_UP_NORMAL, Const.PROP_TAG_MUALANI_SHARKY_BITE],
    [Const.PROP_DMG_RATE_UP_NORMAL, Const.PROP_TAG_MAVUIKA_FLAMESTRIDER],
    [Const.PROP_DMG_RATE_UP_CHARGED, Const.PROP_TAG_WRIOTHESLEY_REBUKE],
    [Const.PROP_DMG_RATE_UP_CHARGED, Const.PROP_TAG_LYNEY_GRIN_MALKIN],
    [Const.PROP_DMG_RATE_UP_CHARGED, Const.PROP_TAG_MAVUIKA_FLAMESTRIDER],
    [Const.PROP_DMG_RATE_UP_PLUNGING, Const.PROP_TAG_VARESA_PLUNGE],
    [Const.PROP_DMG_RATE_UP_PLUNGING, Const.PROP_TAG_VARESA_FIERY_PASSION_PLUNGE],
    [Const.PROP_DMG_RATE_UP_PLUNGING, Const.PROP_TAG_VARESA_VOLCANO_KABLAM],
    [Const.PROP_DMG_RATE_UP_SKILL, Const.PROP_TAG_ALBEDO_TRANSIENT_BLOSSOM],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PROP_TAG_SKIRK_SERPENT_SUBTLETY],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PROP_TAG_RAZOR_SOUL_COMPANION],
    [Const.PROP_DMG_RATE_MULTI_NORMAL, Const.PROP_TAG_MUALANI_SHARKY_BITE],
    [Const.PROP_DMG_RATE_MULTI_NORMAL, Const.PROP_TAG_SKIRK_SEVEN_PHASE_FLASH],
    [Const.PROP_DMG_RATE_MULTI_CHARGED, Const.PROP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT],
    [Const.PROP_DMG_RATE_MULTI_CHARGED, Const.PROP_TAG_NEFER_PHANTASM_PERFORMANCE],
    [Const.PROP_DMG_RATE_MULTI_SKILL, Const.PROP_TAG_FURINA_SALON_SOLITAIRE],
    [Const.PROP_DMG_RATE_MULTI_SKILL, Const.PROP_TAG_VENTI_SKILL_PRESS],
    [
      Const.PROP_DMG_RATE_MULTI_ELEMENTAL_BURST,
      Const.PROP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT,
    ],
    [Const.PROP_DMG_RATE_UP_SKILL, Const.PROP_TAG_FREMINET_FROST],
    [Const.PROP_DMG_RATE_UP_SKILL, Const.PROP_TAG_FISCHL_OZ],
    [Const.PROP_DMG_RATE_UP_SKILL, Const.PROP_TAG_KINICH_SCALESPIKER_CANNON],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PROP_TAG_RAIDEN_ITTOU],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PROP_TAG_RAIDEN_ISSHIN],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PROP_TAG_EULA_KOUKEN],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PROP_TAG_MAVUIKA_FLAMESTRIDER],
    [Const.PROP_DMG_CRIT_RATE_UP_CHARGED, Const.PROP_TAG_WRIOTHESLEY_REBUKE],
    [Const.PROP_DMG_CRIT_RATE_UP_CHARGED, Const.PROP_TAG_SETHOS_SHADOWPIERCING_SHOTS],
    [Const.PROP_DMG_CRIT_RATE_UP_SKILL, Const.PROP_TAG_FREMINET_SHATTERING_PRESSURE],
    [Const.PROP_DMG_CRIT_RATE_UP_SKILL, Const.PROP_TAG_NAHIDA_TRI_KARMA],
    [Const.PROP_DMG_CRIT_RATE_UP_SKILL, Const.PROP_TAG_NAVIA_SHARDSHOT],
    [Const.PROP_DMG_CRIT_RATE_UP_PLUNGING, Const.PROP_TAG_GAMING_BESTIAL_ASCENT],
    [Const.PROP_DMG_CRIT_DMG_UP_CHARGED, Const.PROP_TAG_WRIOTHESLEY_REBUKE],
    [Const.PROP_DMG_CRIT_DMG_UP_CHARGED, Const.PROP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT],
    [Const.PROP_DMG_CRIT_DMG_UP_CHARGED, Const.PROP_TAG_CHASCA_SHADOWHUNT_SHELL],
    [Const.PROP_DMG_CRIT_DMG_UP_CHARGED, Const.PROP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL],
    [Const.PROP_DMG_CRIT_DMG_UP_SKILL, Const.PROP_TAG_NAVIA_SHARDSHOT],
    [Const.PROP_DMG_CRIT_DMG_UP_SKILL, Const.PROP_TAG_KINICH_SCALESPIKER_CANNON],
    [Const.PROP_DMG_CRIT_DMG_UP_PLUNGING, Const.PROP_TAG_GAMING_BESTIAL_ASCENT],
    [
      Const.PROP_DMG_ENEMY_DEFENSE_IGNORE_ELEMENTAL_BURST,
      Const.PROP_TAG_DURIN_PRINCIPLE_OF_DARKNESS,
    ],
    [Const.PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_UP, Const.PROP_TAG_ZIBAI_SPIRIT_STEED_SECOND_HIT],
  ];
  ...
  //ベース属性リスト（武器）
  static readonly PROPS_WEAPON_BASE = [Const.PROP_LEVEL, Const.PROP_ATTACK];
  //サブ属性リスト（キャラ、武器）
  ...
  //敵防御
  static readonly PROPS_ENEMY_DEFENSE = [Const.PROP_DMG_ENEMY_DEFENSE_BASE];
  //サブ属性リスト（敵）
  static readonly PROPS_ENEMY_SUB = Const.PROPS_CHARA_WEAPON_SUB.concat(Const.PROPS_ENEMY_ANTI);
  //パーセント属性リスト（キャラ、武器）
  ...
  static readonly PROPS_ALL_BASE = [
    Const.PROP_VAR_CHARA_1,
    Const.PROP_VAR_CHARA_2,
    Const.PROP_VAR_CHARA_3,
    Const.PROP_VAR_CHARA_4,
    Const.PROP_VAR_CHARA_5,
    Const.PROP_VAR_CHARA_6,
    Const.PROP_VAR_CHARA_7,
    Const.PROP_VAR_CHARA_8,
    Const.PROP_VAR_SET_1,
    Const.PROP_VAR_SET_2,
    Const.PROP_VAR_WEAPON_1,
    Const.PROP_VAR_WEAPON_2,
    Const.PROP_LEVEL,
    Const.PROP_HP_BASE,
    Const.PROP_ATTACK_BASE,
    Const.PROP_DEFENSE_BASE,
    Const.PROP_HP_BASE_EXTRA,
    Const.PROP_ATTACK_BASE_EXTRA,
    Const.PROP_DEFENSE_BASE_EXTRA,
    ...
    Const.PROP_DMG_RATE_MULTI_MOON_HYDROCRYSTALLIZE,
    Const.PROP_DMG_RATE_MULTI_MOON_RUPTURE,
    Const.PROP_DMG_BASICS_MULTI_MOON_RUPTURE,
    ...
    Const.PROP_DMG_ELEMENT_MOON_RUPTURE_EXTRA_VAL_UP,
    Const.PROP_DMG_ELEMENT_MOON_ELECTROCHARGED_EXTRA_VAL_UP,
    Const.PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_EXTRA_VAL_UP,
    Const.PROP_DMG_ELEMENT_RUPTURE_EXTRA_VAL_UP,
    Const.PROP_DMG_ELEMENT_BURGEON_EXTRA_VAL_UP,
    Const.PROP_DMG_ELEMENT_HYPERBLOOM_EXTRA_VAL_UP,
    ...
    Const.PROP_DMG_CRIT_RATE_UP_ELEMENT_MOON_RUPTURE,
    Const.PROP_DMG_CRIT_RATE_UP_ELEMENT_MOON,
    ...
    Const.PROP_DMG_CRIT_DMG_UP_ELEMENT_MOON_RUPTURE,
    Const.PROP_DMG_CRIT_DMG_UP_ELEMENT_MOON,
    Const.PROP_DMG_ELEMENT_UP,
    Const.PROP_DMG_ELEMENT_MOON_ALL_UP,
    ...
    Const.PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_UP,
    ...
    Const.PROP_DMG_ELEMENT_MOON_RUPTURE_UP,
    ...
    Const.PROP_DMG_ELEMENT_MOON_ELECTROCHARGED_PROMOTION,
    Const.PROP_DMG_ELEMENT_MOON_RUPTURE_PROMOTION,
    Const.PROP_DMG_ELEMENT_MOON_HYDROCRYSTALLIZE_PROMOTION,
    Const.PROP_DMG_ELEMENT_MOON_PROMOTION,
    ...
    Const.PROPS_ALL_BASE_SPACIAL_PERCENT.concat(Const.PROPS_ALL_BASE_SPACIAL).map(
      (val: string[]) => {
  ...
  static readonly PROPS_ALL_DATA_PERCENT = [
    ...
    Const.PROPS_ALL_BASE_SPACIAL_PERCENT.map((val: string[]) => {
      return val.join(Const.CONCATENATION_TAG);
    }),
  );
  //計算後データ属性リスト
  ...
  static readonly PROPS_ARTIFACT_FLOWER = [Const.PROP_HP];
  static readonly PROPS_ARTIFACT_PLUME = [Const.PROP_ATTACK];
  ...
  static readonly PROPS_OPTIMAL_DAMAGE_TYPE_LIST_MAP: Map<string, string[]> = new Map([
    ...
    [Const.PROP_DMG_BONUS_PHYSICAL, ['originDmg', 'critDmg', 'expectDmg', 'destructionDmg']],
    [
      Const.PROP_DMG_BONUS_ELECTRO,
      [
        'originDmg',
    ...
    [Const.PROP_DMG_BONUS_GEO, ['originDmg', 'critDmg', 'expectDmg']],
    [
      Const.PROP_DMG_BONUS_PYRO,
      [
        'originDmg',
  ...
  static readonly PROPS_OPTIMAL_DAMAGE_TYPE_LIST_ABS_MAP: Map<string, string[]> = new Map([
    [Const.PROP_DMG_BONUS_CRYO, ['originDmg', 'superconductDmg']],
    [
      Const.PROP_DMG_BONUS_ANEMO,
      [
        'originDmg',
    ...
    [Const.PROP_DMG_BONUS_PHYSICAL, ['originDmg']],
    [
      Const.PROP_DMG_BONUS_ELECTRO,
      [
        'originDmg',
  ...
  //*********************************
  // 超链接CSS类名
  static readonly HYPERLINK_CSS_CLASS = 'hyperlink';
  // 超链接数据属性名（使用xlink:href避免Angular清理）
  static readonly HYPERLINK_DATA_ATTR = 'xlink:href';
  // 超链接正则表达式（匹配新的属性名）
  static readonly HYPERLINK_REGEX = /<span class="hyperlink" xlink:href="([A-Za-z]*\d+)">(.*?)<\/span>/g;
  // 超链接悬停延迟（毫秒）
  static readonly HYPERLINK_HOVER_DELAY = 300;
  // 超链接工具提示最大宽度（像素）
  static readonly HYPERLINK_TOOLTIP_MAX_WIDTH = 300;
  // 超链接工具提示最大高度（像素）
  static readonly HYPERLINK_TOOLTIP_MAX_HEIGHT = 200;
}
