...
export class Const {
  ...
  static readonly PORP_TAG_SETHOS_DUSK_BOLTS = 'SETHOS_DUSK_BOLTS';
  static readonly PORP_TAG_SETHOS_SHADOWPIERCING_SHOTS = 'SETHOS_SHADOWPIERCING_SHOTS';
  static readonly PORP_TAG_EMILIE_CLEARDEW_COLOGNE = 'EMILIE_CLEARDEW_COLOGNE';
  static readonly PORP_TAG_KINICH_SCALESPIKER_CANNON = 'KINICH_SCALESPIKER_CANNON';
  static readonly PORP_TAG_MUALANI_SHARKY_BITE = 'MUALANI_SHARKY_BITE';
  static readonly PORP_TAG_CHASCA_SHADOWHUNT_SHELL = 'CHASCA_SHADOWHUNT_SHELL';
  static readonly PORP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL = 'CHASCA_SHINING_SHADOWHUNT_SHELL';
  static readonly PORP_TAG_ORORON_HYPERSENSE = 'ORORON_HYPERSENSE';
  static readonly PORP_TAG_MAVUIKA_FLAMESTRIDER = 'MAVUIKA_FLAMESTRIDER';
  static readonly PORP_TAG_CITLALI_FROSTFALL_STORM = 'CITLALI_FROSTFALL_STORM';
  static readonly PORP_TAG_CITLALI_ICE_STORM = 'CITLALI_ICE_STORM';
  static readonly PORP_TAG_VARESA_PLUNGE = 'VARESA_PLUNGE';
  static readonly PORP_TAG_VARESA_FIERY_PASSION_PLUNGE = 'VARESA_FIERY_PASSION_PLUNGE';
  static readonly PORP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST =
    'VARESA_FIERY_PASSION_ELEMENTAL_BURST';
  static readonly PORP_TAG_VARESA_VOLCANO_KABLAM = 'VARESA_VOLCANO_KABLAM';
  static readonly PORP_TAG_SKIRK_SERPENT_SUBTLETY = 'SKIRK_SERPENT_SUBTLETY';
  static readonly PORP_TAG_SKIRK_SEVEN_PHASE_FLASH = 'SKIRK_SEVEN_PHASE_FLASH';
  static readonly PORP_TAG_NEFER_PHANTASM_PERFORMANCE = 'NEFER_PHANTASM_PERFORMANCE';
  static readonly PORP_TAG_DURIN_PRINCIPLE_OF_DARKNESS = 'DURIN_PRINCIPLE_OF_DARKNESS';
  static readonly PORP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT =
    'JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT';
  static readonly PORP_TAG_RAZOR_SOUL_COMPANION = 'RAZOR_SOUL_COMPANION';
  static readonly PORP_TAG_VENTI_SKILL_PRESS = 'VENTI_SKILL_PRESS';
  static readonly PORP_TAG_ALBEDO_TRANSIENT_BLOSSOM = 'ALBEDO_TRANSIENT_BLOSSOM';
  static readonly PORP_TAG_ALBEDO_FATAL_BLOSSOM = 'ALBEDO_FATAL_BLOSSOM';
  ...
  static readonly PROPS_TAG_LIST = [
    ...
    Const.PORP_TAG_SETHOS_DUSK_BOLTS,
    Const.PORP_TAG_SETHOS_SHADOWPIERCING_SHOTS,
    Const.PORP_TAG_EMILIE_CLEARDEW_COLOGNE,
    Const.PORP_TAG_KINICH_SCALESPIKER_CANNON,
    Const.PORP_TAG_MUALANI_SHARKY_BITE,
    Const.PORP_TAG_CHASCA_SHADOWHUNT_SHELL,
    Const.PORP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL,
    Const.PORP_TAG_ORORON_HYPERSENSE,
    Const.PORP_TAG_MAVUIKA_FLAMESTRIDER,
    Const.PORP_TAG_CITLALI_FROSTFALL_STORM,
    Const.PORP_TAG_CITLALI_ICE_STORM,
    Const.PORP_TAG_VARESA_PLUNGE,
    Const.PORP_TAG_VARESA_FIERY_PASSION_PLUNGE,
    Const.PORP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST,
    Const.PORP_TAG_VARESA_VOLCANO_KABLAM,
    Const.PORP_TAG_SKIRK_SERPENT_SUBTLETY,
    Const.PORP_TAG_SKIRK_SEVEN_PHASE_FLASH,
    Const.PORP_TAG_NEFER_PHANTASM_PERFORMANCE,
    Const.PORP_TAG_DURIN_PRINCIPLE_OF_DARKNESS,
    Const.PORP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT,
    Const.PORP_TAG_RAZOR_SOUL_COMPANION,
    Const.PORP_TAG_VENTI_SKILL_PRESS,
    Const.PORP_TAG_ALBEDO_TRANSIENT_BLOSSOM,
    Const.PORP_TAG_ALBEDO_FATAL_BLOSSOM,
  ];

  static readonly PROPS_TAG_MAP: Map<string, string[]> = new Map([
    ['10000020', [Const.PORP_TAG_RAZOR_SOUL_COMPANION]],
    ['10000022', [Const.PORP_TAG_VENTI_SKILL_PRESS]],
    ['10000038', [Const.PORP_TAG_ALBEDO_TRANSIENT_BLOSSOM]],
    ['10000038', [Const.PORP_TAG_ALBEDO_FATAL_BLOSSOM]],
    ['10000052', [Const.PORP_TAG_RAIDEN_ITTOU, Const.PORP_TAG_RAIDEN_ISSHIN]],
    ['10000051', [Const.PORP_TAG_EULA_KOUKEN]],
    ['10000070', [Const.PORP_TAG_NILOU_MOON]],
    ['10000071', [Const.PORP_TAG_CYNO_BOLT, Const.PORP_TAG_CYNO_Q]],
    ['10000073', [Const.PORP_TAG_NAHIDA_TRI_KARMA]],
    ['10000074', [Const.PORP_TAG_LAYLA_SHOOTING_STAR]],
    ['10000031', [Const.PORP_TAG_FISCHL_OZ]],
    ['10000078', [Const.PORP_TAG_ALHAITHAM_MIRROR]],
    ['10000079', [Const.PORP_TAG_DEHYA_FIELD]],
    ['10000084', [Const.PORP_TAG_LYNEY_GRIN_MALKIN]],
    ['10000085', [Const.PORP_TAG_FREMINET_FROST, Const.PORP_TAG_FREMINET_SHATTERING_PRESSURE]],
    ['10000086', [Const.PORP_TAG_WRIOTHESLEY_REBUKE]],
    ['10000087', [Const.PORP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT]],
    ['10000089', [Const.PORP_TAG_FURINA_SALON_SOLITAIRE, Const.PORP_TAG_FURINA_NORMAL_C6]],
    ['10000091', [Const.PORP_TAG_NAVIA_SHARDSHOT]],
    ['10000092', [Const.PORP_TAG_GAMING_BESTIAL_ASCENT]],
    ['10000097', [Const.PORP_TAG_SETHOS_DUSK_BOLTS, Const.PORP_TAG_SETHOS_SHADOWPIERCING_SHOTS]],
    ['10000099', [Const.PORP_TAG_EMILIE_CLEARDEW_COLOGNE]],
    ['10000101', [Const.PORP_TAG_KINICH_SCALESPIKER_CANNON]],
    ['10000102', [Const.PORP_TAG_MUALANI_SHARKY_BITE]],
    ['10000104', [Const.PORP_TAG_CHASCA_SHADOWHUNT_SHELL]],
    ['10000104', [Const.PORP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL]],
    ['10000105', [Const.PORP_TAG_ORORON_HYPERSENSE]],
    ['10000106', [Const.PORP_TAG_MAVUIKA_FLAMESTRIDER]],
    ['10000107', [Const.PORP_TAG_CITLALI_FROSTFALL_STORM]],
    ['10000107', [Const.PORP_TAG_CITLALI_ICE_STORM]],
    ['10000111', [Const.PORP_TAG_VARESA_PLUNGE]],
    ['10000111', [Const.PORP_TAG_VARESA_FIERY_PASSION_PLUNGE]],
    ['10000111', [Const.PORP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST]],
    ['10000111', [Const.PORP_TAG_VARESA_VOLCANO_KABLAM]],
    ['10000114', [Const.PORP_TAG_SKIRK_SERPENT_SUBTLETY]],
    ['10000114', [Const.PORP_TAG_SKIRK_SEVEN_PHASE_FLASH]],
    ['10000122', [Const.PORP_TAG_NEFER_PHANTASM_PERFORMANCE]],
    ['10000123', [Const.PORP_TAG_DURIN_PRINCIPLE_OF_DARKNESS]],
    ['10000124', [Const.PORP_TAG_JAHODA_PURRSONAL_COORDINATED_ASSISTANCE_ROBOT]],
    ['10000005503', [Const.PORP_TAG_TRAVELER_TORRENT_SURGE, Const.PORP_TAG_TRAVELER_DEWDROP]],
    ['10000007703', [Const.PORP_TAG_FREMINET_FROST, Const.PORP_TAG_FREMINET_SHATTERING_PRESSURE]],
  ]);
  ...
  static readonly PROPS_ALL_BASE_SPACIAL = [
    ...
    [Const.PROP_DMG_VAL_UP_NORMAL, Const.PORP_TAG_FURINA_NORMAL_C6],
    [Const.PROP_DMG_VAL_UP_CHARGED, Const.PORP_TAG_FURINA_NORMAL_C6],
    [Const.PROP_DMG_VAL_UP_CHARGED, Const.PORP_TAG_SETHOS_DUSK_BOLTS],
    [Const.PROP_DMG_VAL_UP_CHARGED, Const.PORP_TAG_SETHOS_SHADOWPIERCING_SHOTS],
    [Const.PROP_DMG_VAL_UP_PLUNGING, Const.PORP_TAG_FURINA_NORMAL_C6],
    [Const.PROP_DMG_VAL_UP_PLUNGING, Const.PORP_TAG_VARESA_PLUNGE],
    ...
    [Const.PROP_DMG_VAL_UP_SKILL, Const.PORP_TAG_CITLALI_FROSTFALL_STORM],
    [Const.PROP_DMG_VAL_UP_ELEMENTAL_BURST, Const.PORP_TAG_CITLALI_ICE_STORM],
    [Const.PROP_DMG_VAL_UP_ELEMENTAL_BURST, Const.PORP_TAG_ALBEDO_FATAL_BLOSSOM],
  ];

  static readonly PROPS_ALL_BASE_SPACIAL_PERCENT = [
    [Const.PROP_DMG_BONUS_NORMAL, Const.PORP_TAG_SKIRK_SEVEN_PHASE_FLASH],
    [Const.PROP_DMG_BONUS_CHARGED, Const.PORP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL],
    ...
    [Const.PROP_DMG_BONUS_SKILL, Const.PORP_TAG_KINICH_SCALESPIKER_CANNON],
    [Const.PROP_DMG_BONUS_OTHER, Const.PORP_TAG_EMILIE_CLEARDEW_COLOGNE],
    [Const.PROP_DMG_BONUS_OTHER, Const.PORP_TAG_ORORON_HYPERSENSE],
    [Const.PROP_DMG_BONUS_ELEMENTAL_BURST, Const.PORP_TAG_VARESA_FIERY_PASSION_ELEMENTAL_BURST],
    [Const.PROP_DMG_BONUS_PLUNGING, Const.PORP_TAG_VARESA_VOLCANO_KABLAM],
    [Const.PROP_DMG_RATE_UP_NORMAL, Const.PORP_TAG_MUALANI_SHARKY_BITE],
    [Const.PROP_DMG_RATE_UP_NORMAL, Const.PORP_TAG_MAVUIKA_FLAMESTRIDER],
    ...
    [Const.PROP_DMG_RATE_UP_CHARGED, Const.PORP_TAG_MAVUIKA_FLAMESTRIDER],
    [Const.PROP_DMG_RATE_UP_PLUNGING, Const.PORP_TAG_VARESA_PLUNGE],
    [Const.PROP_DMG_RATE_UP_PLUNGING, Const.PORP_TAG_VARESA_FIERY_PASSION_PLUNGE],
    [Const.PROP_DMG_RATE_UP_PLUNGING, Const.PORP_TAG_VARESA_VOLCANO_KABLAM],
    [Const.PROP_DMG_RATE_UP_SKILL, Const.PORP_TAG_ALBEDO_TRANSIENT_BLOSSOM],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PORP_TAG_SKIRK_SERPENT_SUBTLETY],
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PORP_TAG_RAZOR_SOUL_COMPANION],
    [Const.PROP_DMG_RATE_MULTI_NORMAL, Const.PORP_TAG_MUALANI_SHARKY_BITE],
    [Const.PROP_DMG_RATE_MULTI_NORMAL, Const.PORP_TAG_SKIRK_SEVEN_PHASE_FLASH],
    [Const.PROP_DMG_RATE_MULTI_CHARGED, Const.PORP_TAG_NEUVILLETTE_EQUITABLE_JUDGMENT],
    [Const.PROP_DMG_RATE_MULTI_CHARGED, Const.PORP_TAG_NEFER_PHANTASM_PERFORMANCE],
    [Const.PROP_DMG_RATE_MULTI_SKILL, Const.PORP_TAG_FURINA_SALON_SOLITAIRE],
    [Const.PROP_DMG_RATE_MULTI_SKILL, Const.PORP_TAG_VENTI_SKILL_PRESS],
    [
    ...
    [Const.PROP_DMG_RATE_UP_SKILL, Const.PORP_TAG_KINICH_SCALESPIKER_CANNON],
    ...
    [Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST, Const.PORP_TAG_MAVUIKA_FLAMESTRIDER],
    [Const.PROP_DMG_CRIT_RATE_UP_CHARGED, Const.PORP_TAG_WRIOTHESLEY_REBUKE],
    [Const.PROP_DMG_CRIT_RATE_UP_CHARGED, Const.PORP_TAG_SETHOS_SHADOWPIERCING_SHOTS],
    ...
    [Const.PROP_DMG_CRIT_DMG_UP_CHARGED, Const.PORP_TAG_CHASCA_SHADOWHUNT_SHELL],
    [Const.PROP_DMG_CRIT_DMG_UP_CHARGED, Const.PORP_TAG_CHASCA_SHINING_SHADOWHUNT_SHELL],
    [Const.PROP_DMG_CRIT_DMG_UP_SKILL, Const.PORP_TAG_NAVIA_SHARDSHOT],
    [Const.PROP_DMG_CRIT_DMG_UP_SKILL, Const.PORP_TAG_KINICH_SCALESPIKER_CANNON],
