...
export class Const {
  ...
  //元素スキルダメージ（FREMINET）
  static readonly PROP_DMG_BONUS_SKILL_FREMINET_SHATTERING_PRESSURE = "DMG_BONUS_SKILL" + Const.CONCATENATION_TAG + Const.PORP_TAG_FREMINET_SHATTERING_PRESSURE;
  //元素スキルダメージ（NILOU）
  static readonly PROP_DMG_BONUS_SKILL_NILOU_MOON = "DMG_BONUS_SKILL_NILOU_MOON";
  //元素スキルダメージ（NAHIDA）
  static readonly PROP_DMG_BONUS_SKILL_NAHIDA_TRI_KARMA = "DMG_BONUS_SKILL_NAHIDA_TRI_KARMA";
  //元素スキルダメージ（LAYLA）
  ...
  //重撃ダメージ倍率アップ値(LYNEY)
  static readonly PROP_DMG_RATE_UP_CHARGED_LYNEY_GRIN_MALKIN = "DMG_RATE_UP_CHARGED" + Const.CONCATENATION_TAG + Const.PORP_TAG_LYNEY_GRIN_MALKIN;
  //落下攻撃ダメージ倍率アップ値
  static readonly PROP_DMG_RATE_UP_PLUNGING = "DMG_RATE_UP_PLUNGING";
  //元素スキルダメージ倍率アップ値
  static readonly PROP_DMG_RATE_UP_SKILL = "DMG_RATE_UP_SKILL";
  //元素スキルダメージ倍率アップ値(FREMINET)
  static readonly PROP_DMG_RATE_UP_SKILL_FREMINET_FROST = "DMG_RATE_UP_SKILL" + Const.CONCATENATION_TAG + Const.PORP_TAG_FREMINET_FROST;
  ...
  static readonly PROP_DMG_RATE_UP_ELEMENTAL_BURST_RAIDEN_ITTOU = "DMG_RATE_UP_ELEMENTAL_BURST_RAIDEN_ITTOU";
  //元素爆発ダメージ倍率アップ値（夢想の一心）
  static readonly PROP_DMG_RATE_UP_ELEMENTAL_BURST_RAIDEN_ISSHIN = "DMG_RATE_UP_ELEMENTAL_BURST_RAIDEN_ISSHIN";
  //元素爆発ダメージ倍率アップ値（光臨の剣）
  static readonly PROP_DMG_RATE_UP_ELEMENTAL_BURST_EULA_KOUKEN = "DMG_RATE_UP_ELEMENTAL_BURST_EULA_KOUKEN";
  //武器ダメージ倍率アップ値
  ...
  //元素スキルダメージアップ値（TRAVELER）
  static readonly PROP_DMG_VAL_UP_SKILL_TRAVELER_TORRENT_SURGE = "DMG_VAL_UP_SKILL" + Const.CONCATENATION_TAG + Const.PORP_TAG_TRAVELER_TORRENT_SURGE;
  //元素スキルダメージアップ値（TRAVELER）
  static readonly PROP_DMG_VAL_UP_SKILL_TRAVELER_DEWDROP = "DMG_VAL_UP_SKILL" + Const.CONCATENATION_TAG + Const.PORP_TAG_TRAVELER_DEWDROP;
  //元素スキルダメージアップ値（CYNO）
  static readonly PROP_DMG_VAL_UP_SKILL_CYNO_BOLT = "DMG_VAL_UP_SKILL_CYNO_BOLT";
  //元素スキルダメージアップ値（LAYLA）
  static readonly PROP_DMG_VAL_UP_SKILL_LAYLA_SHOOTING_STAR = "DMG_VAL_UP_SKILL_LAYLA_SHOOTING_STAR";
  //元素爆発ダメージアップ値
  ...
  //元素スキルダメージ会心率アップ値（FREMINET）
  static readonly PROP_DMG_CRIT_RATE_UP_SKILL_FREMINET_SHATTERING_PRESSURE = "DMG_CRIT_RATE_UP_SKILL" + Const.CONCATENATION_TAG + Const.PORP_TAG_FREMINET_SHATTERING_PRESSURE;
  //元素スキルダメージ会心率アップ値（NAHIDA）
  static readonly PROP_DMG_CRIT_RATE_UP_SKILL_NAHIDA_TRI_KARMA = "DMG_CRIT_RATE_UP_SKILL_NAHIDA_TRI_KARMA";
  //元素爆発ダメージ会心率アップ値
  ...
  static readonly PROPS_ALL_BASE = [
    ...
    Const.PROP_DMG_BONUS_PLUNGING,
    Const.PROP_DMG_BONUS_SKILL,
    Const.PROP_DMG_BONUS_SKILL_FREMINET_SHATTERING_PRESSURE,
    ...
    Const.PROP_DMG_RATE_UP_CHARGED_LYNEY_GRIN_MALKIN,
    Const.PROP_DMG_RATE_UP_PLUNGING,
    Const.PROP_DMG_RATE_UP_SKILL,
    Const.PROP_DMG_RATE_UP_SKILL_FREMINET_FROST,
    ...
    Const.PROP_DMG_RATE_UP_ELEMENTAL_BURST_EULA_KOUKEN,
    ...
    Const.PROP_DMG_VAL_UP_SKILL_TRAVELER_TORRENT_SURGE,
    Const.PROP_DMG_VAL_UP_SKILL_TRAVELER_DEWDROP,
    Const.PROP_DMG_VAL_UP_SKILL_CYNO_BOLT,
    Const.PROP_DMG_VAL_UP_SKILL_LAYLA_SHOOTING_STAR,
    ...
    Const.PROP_DMG_CRIT_RATE_UP_SKILL_FREMINET_SHATTERING_PRESSURE,
    Const.PROP_DMG_CRIT_RATE_UP_SKILL_NAHIDA_TRI_KARMA,
