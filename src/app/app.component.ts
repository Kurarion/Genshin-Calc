  ...
  initializeAppFactory(httpService: HttpService): Promise<any> {
    ...
    promiseList.push(
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_CONFIG],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_CONFIG,
          )
          .pipe(
            tap((data) => {
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_GENSHIN_AVATAR],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_GENSHIN_AVATAR,
          )
          .pipe(
            tap((data) => {
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_GENSHIN_WEAPON],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_GENSHIN_WEAPON,
          )
          .pipe(
            tap((data) => {
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_GENSHIN_RELIQUARY_SET],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_GENSHIN_RELIQUARY_SET,
          )
          .pipe(
            tap((data) => {
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_GENSHIN_RELIQUARY_MAIN],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_GENSHIN_RELIQUARY_MAIN,
          )
          .pipe(
            tap((data) => {
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_GENSHIN_RELIQUARY_SUB],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_GENSHIN_RELIQUARY_SUB,
          )
          .pipe(
            tap((data) => {
      ...
      lastValueFrom(
        httpService
          .getSystemData(
            Const.SYS_JSON_URLS[Const.SYS_JSON_DATA_CHIP],
            'json',
            this.jsonDownloadStatus,
            Const.SYS_JSON_DATA_CHIP,
          )
          .pipe(
            tap((data) => {
