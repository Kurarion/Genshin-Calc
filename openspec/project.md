...
- **注释语言规范**:
  - **前端代码**（TypeScript/HTML/CSS）：统一使用**日文**注释，**不使用英文或中文**
  - **后端代码**（Go）：统一使用**中文**注释，**不使用英文或日文**
  - 注释应简洁明了，说明代码的用途和关键逻辑
  - 对于复杂算法或业务逻辑，应提供详细的注释说明
...
### Testing Strategy
- **代码审查**: 所有代码变更必须经过严格的代码审查
- **临时测试**: 如需临时测试代码验证功能，测试完成后必须删除
- **测试原则**:
  - 优先进行代码审查，确保代码质量和逻辑正确性
  - 临时测试代码不应提交到代码库
  - 复杂功能变更需要经过充分的人工审查和验证
- **代码审查要点**:
  - 代码质量和可维护性
  - 业务逻辑正确性
  - 性能影响评估
